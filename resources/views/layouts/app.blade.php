    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div><img src="/svg/1.jpg" style="height:50px; margin-right:15px; border-right:1px solid black;" alt=""></div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css" integrity="sha384-DyZ88mC6Up2uqS4h/KRgHuoeGwBcD4Ng9SiP4dIRy0EXTlnuz47vAwmeGwVChigm" crossorigin="anonymous"> <ul class="navbar-nav ms-auto">
                        ...
                        <a  style="margin-right:20px; text-decoration:none;" class="text-dark" href="/p/create"><i class="far fa-plus-square fa-lg"></i></a>
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                 <img class="rounded-circle" style="height:40px;" src="   {{ Auth::user()->profile->profileImage()  }}" > </a>

                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item" href="/profile/{{ Auth::user()->profile->user_id }}">Home</a>
                                  <hr>
